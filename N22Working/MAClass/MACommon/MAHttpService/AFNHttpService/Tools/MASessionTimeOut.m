    ...
    switch (status) {
        ...
        case AFNetworkReachabilityStatusNotReachable://不可达的网络(未连接)
        {
            ...
            if (sessionTimeOut && sessionTimeOut.offlineBlock) {
                ...
                MAAlertView *alertView = [[MAAlertView alloc] initWithTitle:@"网络提示" message:@"网络已断开，请连接网络！" delegate:sessionTimeOut cancelButtonTitle:nil otherButtonTitles:@"知道了", nil];
                [alertView show];
            }
